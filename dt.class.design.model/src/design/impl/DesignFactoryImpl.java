...
public class DesignFactoryImpl extends EFactoryImpl implements DesignFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DesignPackage.CLASS: return createClass();
			case DesignPackage.ATTRIBUTE: return createAttribute();
			case DesignPackage.OPERATION: return createOperation();
			case DesignPackage.DESIGN: return createDesign();
			case DesignPackage.ASSOCIATION: return createAssociation();
			case DesignPackage.GENERALIZATION: return createGeneralization();
			case DesignPackage.DEPENDENCY: return createDependency();
			case DesignPackage.COMPOSITION: return createComposition();
			case DesignPackage.AGGREGATION: return createAggregation();
			case DesignPackage.REALIZATION: return createRealization();
			case DesignPackage.INTERFACE: return createInterface();
			default:
	 ...
	 * @generated
	 */
	public design.Class createClass() {
