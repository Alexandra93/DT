 ...
 * </p>
 * <ul>
 *   <li>{@link design.impl.DesignImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link design.impl.DesignImpl#getRelations <em>Relations</em>}</li>
 *   <li>{@link design.impl.DesignImpl#getLanguage <em>Language</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DesignImpl extends MinimalEObjectImpl.Container implements Design {
	...
	protected EClass eStaticClass() {
		return DesignPackage.Literals.DESIGN;
	}
	...
	public EList<Classifier> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Classifier>(Classifier.class, this, DesignPackage.DESIGN__ELEMENTS);
		}
		return elements;
	}
	...
	public EList<Relation> getRelations() {
		if (relations == null) {
			relations = new EObjectContainmentEList<Relation>(Relation.class, this, DesignPackage.DESIGN__RELATIONS);
		}
		return relations;
	}
	...
	public void setLanguage(Languages newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DESIGN__LANGUAGE, oldLanguage, language));
	}
