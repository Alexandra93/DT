 ...
 * </p>
 * <ul>
 *   <li>{@link design.impl.RelationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link design.impl.RelationImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	...
	protected EClass eStaticClass() {
		return DesignPackage.Literals.RELATION;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DesignPackage.RELATION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Classifier newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.RELATION__SOURCE, oldSource, source));
	}
	...
	public Classifier getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DesignPackage.RELATION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Classifier newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.RELATION__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DesignPackage.RELATION__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case DesignPackage.RELATION__TARGET:
