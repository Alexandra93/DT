...
/**
 * This is the item provider adapter for a {@link workflow.ParameterDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterDeclarationItemProvider extends DeclarationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.PARAMETER_DECLARATION__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterDeclaration.class)) {
			case WorkflowPackage.PARAMETER_DECLARATION__TYPE:
