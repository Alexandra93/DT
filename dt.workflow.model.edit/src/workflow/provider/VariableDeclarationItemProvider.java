...
/**
 * This is the item provider adapter for a {@link workflow.VariableDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.VARIABLE_DECLARATION__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addIsConstantPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDeclaration_isConstant_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDeclaration_isConstant_feature", "_UI_VariableDeclaration_type"),
				 WorkflowPackage.Literals.VARIABLE_DECLARATION__IS_CONSTANT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
