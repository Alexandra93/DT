...
/**
 * This is the item provider adapter for a {@link workflow.CompilationUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompilationUnitItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.COMPILATION_UNIT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLanguagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CompilationUnit_language_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CompilationUnit_language_feature", "_UI_CompilationUnit_type"),
				 WorkflowPackage.Literals.COMPILATION_UNIT__LANGUAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.COMPILATION_UNIT__DECLARATIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompilationUnit.class)) {
			case WorkflowPackage.COMPILATION_UNIT__NAME:
			case WorkflowPackage.COMPILATION_UNIT__LANGUAGE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case WorkflowPackage.COMPILATION_UNIT__DECLARATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowPackage.Literals.COMPILATION_UNIT__DECLARATIONS,
