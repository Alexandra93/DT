...
/**
 * This is the item provider adapter for a {@link design.Classifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassifierItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Classifier_accessModifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Classifier_accessModifier_feature", "_UI_Classifier_type"),
				 DesignPackage.Literals.CLASSIFIER__ACCESS_MODIFIER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DesignPackage.Literals.CLASSIFIER__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DesignPackage.Literals.CLASSIFIER__ATTRIBUTES);
			childrenFeatures.add(DesignPackage.Literals.CLASSIFIER__OPERATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DesignPackage.Literals.CLASSIFIER__ATTRIBUTES,
				 DesignFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(DesignPackage.Literals.CLASSIFIER__OPERATIONS,
				 DesignFactory.eINSTANCE.createOperation()));
	}
