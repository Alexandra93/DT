 ...
 * </p>
 * <ul>
 *   <li>{@link workflow.impl.ParameterDeclarationImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterDeclarationImpl extends DeclarationImpl implements ParameterDeclaration {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.PARAMETER_DECLARATION;
	}
	...
	public void setType(Type newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.PARAMETER_DECLARATION__TYPE, oldType, type));
	}
