 ...
 * </p>
 * <ul>
 *   <li>{@link workflow.impl.ProcedureCallImpl#getArgument <em>Argument</em>}</li>
 *   <li>{@link workflow.impl.ProcedureCallImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcedureCallImpl extends ExpressionImpl implements ProcedureCall {
	...
	protected EClass eStaticClass() {
		return WorkflowPackage.Literals.PROCEDURE_CALL;
	}
	...
	public EList<Expression> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<Expression>(Expression.class, this, WorkflowPackage.PROCEDURE_CALL__ARGUMENT);
		}
		return argument;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.PROCEDURE_CALL__NAME, oldName, name));
	}
