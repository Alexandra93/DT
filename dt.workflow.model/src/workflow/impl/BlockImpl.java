 ...
 * </p>
 * <ul>
 *   <li>{@link workflow.impl.BlockImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockImpl extends StatementImpl implements Block {
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this, WorkflowPackage.BLOCK__STATEMENT);
		}
		return statement;
	}
